...
begin
 ...
 { number := -1;
  ...
  StringGrid1.Cells[2,i]:= FormatFloat('0.00000',B);
  StringGrid1.Cells[3,i]:= FormatFloat('0.00000',x);
  signo:= funcion(A)* funcion(x);
  StringGrid1.Cells[4,i]:= FormatFloat('0.00000',signo);
  ...
  StringGrid1.Cells[5,i]:=FormatFloat('0.00000',error2);
  anterior:=x;
