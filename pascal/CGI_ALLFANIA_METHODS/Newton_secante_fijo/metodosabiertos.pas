...
function TMetodosabiertos.DisplayTable: string;
var i: Integer ;
 Body: string;
 begin
      Result:= 'Function x^2 -4 <br>' + 'Init value :' ;
 end;
...
begin
  ...
  Result:='                        METODOS ABIERTOS                         <br>' +
  ' 1 .-Newton <br>' + ' 2 .-Secante <br> ' + ' 3 .-Punto Fijo <br>'     ;
  ...
  Result:= Result + '<table border="1" cellpadding="1" cellspacing="1"><tbody>';
  Result:= Result + '<tr>' +
                           '<td>n</td>' +
                           '<td>Xn</td>' +
                           '<td>Error</td>' +
