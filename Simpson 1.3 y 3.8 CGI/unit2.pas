...
Type
  TMetodos = Class
    public
      ...
      function Metodo_Simpson13(Funcion:string;P_inicio,P_final:Extended;NumInter:Integer):string;
      function Metodo_Simpson38(Funcion:string;P_inicio,P_final:Extended;NumInter:Integer):string;
      constructor create();
...
function TMetodos.Metodo_Simpson13(Funcion:string;P_inicio,P_final:Extended;NumInter:Integer):string;
var
...
begin
   Try
      H:=( (P_final-P_inicio)/( 2 * NumInter ) ) / 3;
      PreH :=( (P_final-P_inicio)/( 2 * NumInter ) );
      Temporal:=(f(P_inicio,Funcion)+f(P_final,Funcion));
        while Iterador < (2*NumInter) do begin
             xn:= P_inicio + (PreH * Iterador);
...
function TMetodos.Metodo_Simpson38(Funcion:string;P_inicio,P_final:Extended;NumInter:Integer):string;
var
